...
TEXT ·doEncryptKeyAsm(SB),NOSPLIT|NOFRAME,$0
	...
	LVSR (OUT)(R0), OUTPERM                 // lvsl  8,0,5 -> lvsr 8,0,5
	VSPLTISB $-1, OUTMASK                   // vspltisb      9,-1
	LVX (OUT)(R0), OUTHEAD                  // lvx   10,0,5
	VPERM ZERO, OUTMASK, OUTPERM, OUTMASK   // vperm 9,9,0,8 -> vperm 9,0,9,8 
...
TEXT ·encryptBlockAsm(SB),NOSPLIT|NOFRAME,$0
	...
	VPERM IN0, IN1, MASK, IN0       // vperm 1,2,1,5 -> vperm 1,1,2,5
...
loop_enc:
	VPERM IN1, IN0, MASK, IN1       // vperm 2,1,2,5 -> vperm 2,2,1,5
	...
	MOVD $15, BLK_IDX               // li 7,15
	VPERM IN0, IN1, KEY, IN1        // vperm 2,2,1,3 -> vperm 2,1,2,3
									// Removed for PPC64.
